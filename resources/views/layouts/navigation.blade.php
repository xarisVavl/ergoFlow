<aside
    ...
    <div class="px-3 py-4 border-t border-gray-200 dark:border-gray-700 space-y-1 shrink-0">
        ...
        <button @click="$store.theme.toggle()"
            ...
            <svg x-show="!$store.theme.isDark" class="w-5 h-5 shrink-0" fill="none" stroke="currentColor"
                viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div x-data="{ open: false }" class="relative">
            <button @click="open = !open"
                ...
                <div class="flex-1 text-left min-w-0">
                    <p class="text-sm font-medium text-gray-800 dark:text-gray-200 truncate">{{ Auth::user()->name }}
                    </p>
